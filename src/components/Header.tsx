        ...
        <div className="flex justify-between items-center py-4 relative">
          ...
          <nav className="hidden md:flex space-x-6 items-center">
            ...
            <motion.a
              ...
              className="ml-4 px-5 py-2 bg-black text-yellow-400 font-semibold rounded-lg hover:bg-gray-900 transition"
            >
              Book a Ride
            </motion.a>
          </nav>
          ...
          >
            <img src="/taxi-icon.png" alt="Taxi Icon" className="h-10 w-10" />
          </motion.div>
        </div>
          ...
          {isMenuOpen && (
            ...
            >
              <nav className="flex flex-col space-y-4">
                ...
                <a
                  href="#booking"
                  className="mt-2 px-4 py-2 bg-black text-yellow-400 font-semibold rounded-lg text-center hover:bg-gray-900 transition"
                >
                  Book a Ride
                </a>
                {/* Mobile Phone */}
